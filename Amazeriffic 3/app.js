/***
 * Name: Ben Brown
 * Description: Creates a to-do list using JSON.  The list can be organized in reverse order as well.  Tags can also be added with additional information.
 * 
 */
var main = function(toDoObjects) {
    ...
    $(".tabs a span").toArray().forEach(function(element){
        ...
        $(element).on("click", function(){
            ...
            // depending on the tab clicked a condition is selected and loads the corresponding questions and answer.
